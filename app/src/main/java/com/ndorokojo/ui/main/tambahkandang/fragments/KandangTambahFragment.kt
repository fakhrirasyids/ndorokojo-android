                ...
                if (isValid()) {
                    ...
                    with(builder)
                    {
                        ...
                        setPositiveButton("Benar") { dialog, _ ->
                            dialog.dismiss()
                            BottomSheetTambahKandang.changeFragmentToIndex(1)
                        }
        ...
        binding.apply {
            edName.addTextChangedListener {
                if (binding.edName.text.toString().isEmpty()) {
                    storeKandangViewModel?.isNameFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isNameFilled?.postValue(true)
                }
            }

            edPanjang.addTextChangedListener {
                if (binding.edPanjang.text.toString().isEmpty()) {
                    storeKandangViewModel?.isPanjangFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isPanjangFilled?.postValue(true)
                }
            }

            edLebar.addTextChangedListener {
                if (binding.edLebar.text.toString().isEmpty()) {
                    storeKandangViewModel?.isLebarFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isLebarFilled?.postValue(true)
                }
            }
            ...
            edJenisKandang.addTextChangedListener {
                if (binding.edJenisKandang.text.toString().isEmpty()) {
                    storeKandangViewModel?.isJenisKandangFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isJenisKandangFilled?.postValue(true)
                }
            }

            edProvinsi.addTextChangedListener {
                if (binding.edProvinsi.text.toString().isEmpty()) {
                    storeKandangViewModel?.isProvinceFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isProvinceFilled?.postValue(true)
                }
            }

            edKabupaten.addTextChangedListener {
                if (binding.edKabupaten.text.toString().isEmpty()) {
                    storeKandangViewModel?.isRegencyFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isRegencyFilled?.postValue(true)
                }
            }

            edKecamatan.addTextChangedListener {
                if (binding.edKecamatan.text.toString().isEmpty()) {
                    storeKandangViewModel?.isDistrictFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isDistrictFilled?.postValue(true)
                }
            }

            edDesaKel.addTextChangedListener {
                if (binding.edDesaKel.text.toString().isEmpty()) {
                    storeKandangViewModel?.isVillageFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isVillageFilled?.postValue(true)
                }
            }

            edAddress.addTextChangedListener {
                if (binding.edAddress.text.toString().isEmpty()) {
                    storeKandangViewModel?.isAddressFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isAddressFilled?.postValue(true)
                }
            }

            edRtrw.addTextChangedListener {
                if (binding.edRtrw.text.toString().isEmpty()) {
                    storeKandangViewModel?.isRtRwFilled?.postValue(false)
                } else {
                    storeKandangViewModel?.isRtRwFilled?.postValue(true)
                }
            }
